...
VERTEX_15 = Vertex(x=0.8172043010752689, y=0.0, z=0.5, id=14)
...
VERTEX_24 = Vertex(x=0.3333333333333333, y=1.0, z=0.5, id=23)
VERTEX_25 = Vertex(x=0.6666666666666666, y=1.0, z=0.5, id=24)
...
faces = [
    [13, 14, 15, 25, 24, 21, 20, 23, 22],
    [0, 9, 10, 7, 8, 11, 12, 2, 1],
    [16, 17, 19, 18],
    [3, 5, 6, 4],
    [22, 9, 0, 13],
    [13, 0, 1, 14],
